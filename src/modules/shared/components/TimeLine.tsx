...
const Timeline = ({ previousStep, nextStep, maxWidth = 520 }: CreationTimelineProps): React.ReactNode => (
    <Box sx={{ width: "100%", maxWidth, display: "grid", gridTemplateColumns: "80px 1fr 80px", alignItems: "start", mb: 4 }}>
        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 1.5 }}>
            <Box sx={theme => ({ width: 58, height: 58, borderRadius: "50%", border: `0.1em solid ${theme.custom.posAccent}`, backgroundColor: `${theme.custom.whiteDark}15`, display: "flex", alignItems: "center", justifyContent: "center", color: theme.custom.posAccent })}>
                {previousStep.icon}
            </Box>
        ...
        <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", mt: "29px" }}>
            ...
            <Box sx={theme => ({ flex: 1, height: 2, backgroundImage: `repeating-linear-gradient(to right, ${theme.custom.lightGray}, ${theme.custom.whiteDark}40 6px, transparent 6px, transparent 12px)` })} />
        </Box>

        <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 1.5 }}>
            <Box sx={theme => ({ width: 58, height: 58, borderRadius: "50%", border: `0.2em dotted ${theme.custom.lightGray}`, backgroundColor: `${theme.custom.whiteDark}15`, display: "flex", alignItems: "center", justifyContent: "center", color: theme.custom.whiteDark })}>
                {nextStep.icon}
            </Box>
