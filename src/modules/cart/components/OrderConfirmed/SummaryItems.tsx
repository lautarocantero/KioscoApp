...
export const getTicketSummaryItems = (ticketSummary: TicketSummaryType): SummaryItem[] => [
    {
        ...
        label: i18n.t('cart.orderConfirmed.summary.products'),
    ...
    },
    {
        ...
        iconColor: (theme) => theme?.palette?.primary?.main,
        label: i18n.t('cart.orderConfirmed.summary.total'),
    ...
    },
    {
        ...
        iconColor: (theme) => theme?.palette?.primary?.main,
        label: i18n.t('cart.orderConfirmed.summary.paymentMethod'),
    ...
    },
    {
        ...
        iconColor: (theme) => theme?.palette?.primary?.main,
        label: i18n.t('cart.orderConfirmed.summary.date'),
