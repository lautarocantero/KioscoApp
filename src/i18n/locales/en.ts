...
const en = {
  ...
  membership: {
    ...
    features: {
      standardSellers: "Up to 2 members per kiosco",
      standardKioscos: "1 kiosco",
      standardProducts: "Up to 1,150 products",
      standardReports: "Current month reports",
      standardSupport: "Email support",
      deluxeSellers: "Unlimited members",
