...
const es = {
  ...
  membership: {
    ...
    features: {
      standardSellers: "Hasta 2 miembros por kiosco",
      standardKioscos: "1 kiosco",
      standardProducts: "Hasta 1.150 productos",
      standardReports: "Reportes del mes actual",
      standardSupport: "Soporte por email",
      deluxeSellers: "Miembros ilimitados",
