...
const es = {
  ...
  landing: {
    ...
    hero: {
      titleStart: "Stock y ventas en ",
      titleHighlight: "un solo lugar",
      previewAlt: "Panel de control de Stocko en una tableta",
      download: "Descargar",
      openInBrowser: "Abrir en el navegador",
      benefits: {
        sell: "Vendés en dos toques, sin calculadora",
        stock: "El stock se actualiza solo con cada venta",
        restock: "Sabés qué reponer antes de quedarte sin nada",
        cashClose: "Cerrás la caja viendo cuánto ganaste hoy",
      },
    },
    showcase: {
      // "{{value}}" es el saves de cada feature (ver savesKey en getLandingFeatureShowcase.ts).
      saves: "Te ahorra: {{value}}",
      productsStock: {
        badge: "Stock",
        titleStart: "Cargás la mercadería ",
        titleHighlight: "una sola vez",
        titleEnd: "",
        subtitle:
        ...
        saves: "Contar góndola y perder ventas por faltantes",
        items: {
          manageProducts: { label: "Alta de productos en un minuto", detail: "Nombre, precio, stock y listo." },
          multiplePresentations: { label: "Varias presentaciones", detail: "Unidad, pack o caja del mismo producto." },
          lowStockAlerts: { label: "Alertas de stock bajo", detail: "Te avisa antes de que se termine." },
        },
        mediaAlt: "Vista previa de la gestión de productos y stock en Stocko",
      },
      sellsReports: {
        badge: "Ventas",
        titleStart: "Vendés y el reporte ",
        titleHighlight: "se arma solo",
        titleEnd: "",
        subtitle:
          "Cada venta queda registrada al instante: qué salió, a qué hora y quién la hizo. Los números del día y del mes están listos sin tocar una planilla.",
        saves: "El cierre de caja a mano y la planilla del domingo",
        items: {
          realtimeReports: { label: "Reportes en tiempo real", detail: "El día, la semana y el mes, siempre al día." },
          sellsHistory: { label: "Historial completo de ventas", detail: "Buscás cualquier venta en segundos." },
          sellerAnalysis: { label: "Rendimiento por vendedor", detail: "Sabés quién vende y cuánto." },
        },
        mediaAlt: "Vista previa de reportes y ventas en Stocko",
      },
      receiptsProviders: {
        badge: "Proveedores",
        titleStart: "Se terminó ",
        titleHighlight: "la caja de papeles",
        titleEnd: "",
        subtitle:
          "Cargás el comprobante en segundos y queda asociado al proveedor, con fecha y monto. Cuando necesitás saber cuánto le comprás a quién, está ahí y es buscable.",
        saves: "Buscar una factura entre papeles",
        items: {
          fastReceiptUpload: { label: "Carga de comprobantes en segundos", detail: "Subís la factura y queda guardada." },
          providerControl: { label: "Control de proveedores", detail: "Cuánto le comprás a cada uno." },
          historyAlwaysAvailable: { label: "Historial siempre disponible", detail: "Todo respaldado y buscable." },
        },
        mediaAlt: "Vista previa de la gestión de boletas y proveedores en Stocko",
      },
      multiKiosco: {
        badge: "Multi-local",
        titleStart: "Varios kioscos, ",
        titleHighlight: "una sola cuenta",
        titleEnd: "",
        subtitle:
        ...
        saves: "Una sola cuenta y un control por cada local",
        items: {
          multipleKioscosOneAccount: { label: "Varios kioscos en una cuenta", detail: "Entrás una vez y elegís el local." },
          sellerManagement: { label: "Gestión de vendedores", detail: "Cada empleado con su usuario." },
          rolePermissions: { label: "Permisos por rol", detail: "Definís qué puede ver y tocar cada uno." },
        },
  ...
  stadistics: {
    ...
    monthlyReport: {
      header: {
        kioscoLine: "{{kioscoName}} · reporte cerrado",
        title: "Reporte mensual · {{month}}",
        daysLabel: "{{count}} días",
        daysLabel_one: "{{count}} día",
        comparedWith: "comparado con {{month}}",
        monthAriaLabel: "Mes del reporte",
        compareAriaLabel: "Comparar con",
        compareOptions: {
          previous_month: "Comparar con el mes anterior",
          previous_year: "Comparar con el mismo mes del año pasado",
          none: "Sin comparación",
        },
        planOnly: "Disponible en el plan Deluxe del dueño del kiosco",
      ...
      dailyChart: {
        ...
        subtitle: "Promedio diario {{avgPerDay}} · {{count}} días cerrados",
        subtitle_one: "Promedio diario {{avgPerDay}} · {{count}} día cerrado",
        subtitle_zero: "Promedio diario {{avgPerDay}} · sin días cerrados",
        legendRegular: "día común",
        legendBest: "mejor día",
        bestDay: "Mejor día",
        worstDay: "Día más flojo",
        bestWeek: "Mejor semana",
        dayAmount: "Día {{day}} · {{amount}}",
        weekAmount: "Días {{week}} · {{amount}}",
      },
      sellers: {
        title: "Vendedores",
        viewAll: "Ver todos",
        ...
        new: "primer mes",
        empty: "Todavía no hay ventas de vendedores este mes.",
        note: "{{sellerName}} hizo el ticket más alto ({{amount}}).",
      },
      paymentMethods: {
        ...
        methods: {
          ...
          debit: "Débito",
          credit: "Crédito",
          transfer: "QR / billetera",
        },
      },
      hourly: {
        title: "Horarios",
        subtitle: "Franjas de 2 horas entre las 08 y las 24.",
        peakChip: "pico {{range}} h",
        lowChip: "más floja {{range}} h",
      },
      stockAlerts: {
        title: "Plata dormida",
        badge: "revisar",
        subtitle: "Quiebres y stock que no rota.",
        outOfStockCount: "Productos sin stock",
        soldBefore: "De esos, vendían antes",
        lostRevenue: "Venta que no pudiste hacer",
        deadStockCount: "Sin vender hace 60 días",
        note: "{{value}} quietos en el estante. El más viejo: {{name}}, {{days}} días.",
        noteEmpty: "{{value}} quietos en el estante.",
        restockButton: "Armar boleta de reposición",
      },
      currentAccount: {
        title: "Cuenta corriente",
        subtitle: "Deuda de clientes y cobranzas del mes.",
        debtorsCount: "Clientes con deuda",
        totalDebt: "Deuda acumulada",
        collectedThisMonth: "Cobrado en el mes",
        newDebtThisMonth: "Deuda nueva del mes",
        note: "{{count}} pagos registrados este mes.",
        note_one: "{{count}} pago registrado este mes.",
        note_zero: "Sin pagos registrados este mes.",
        viewDebtorsButton: "Ver morosos",
      },
      footer: {
        generated: "Stocko · {{kioscoName}} · generado el {{date}}",
      },
      pdf: {
        title: "Reporte mensual · {{month}}",
        kioscoLabel: "Kiosco: {{kioscoName}}",
        generatedAtLabel: "Generado el {{date}}",
        columns: {
          metric: "Métrica",
          value: "Valor",
          seller: "Vendedor",
        ...
        fileNamePrefix: "reporte_mensual",
      },
    },
  },
};
