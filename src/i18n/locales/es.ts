...
const es = {
  ...
  membership: {
    ...
    features: {
      stockoSellers: "Hasta 2 vendedores",
      stockoKioscos: "1 kiosco",
      stockoProducts: "Hasta 300 productos",
      stockoReports: "Reportes básicos de stock y ventas",
      stockoSupport: "Soporte por email",
      superSellers: "Hasta 5 vendedores",
      superKioscos: "Hasta 3 kioscos",
      superProducts: "Productos ilimitados",
      superReports: "Reportes avanzados y boleta de reposición",
      superHistory: "Historial de ventas completo",
      superSupport: "Soporte prioritario",
      maxiSellers: "Vendedores ilimitados",
      maxiKioscos: "Kioscos ilimitados",
      maxiProducts: "Productos ilimitados",
      maxiReports: "Reportes y métricas avanzadas",
      maxiNotifications: "Notificaciones de stock en tiempo real",
      maxiSupport: "Soporte 24/7",
    },
    checkout: {
