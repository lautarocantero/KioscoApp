...
// Toda la orquestación de /membership/plans: status actual + los 3 tiers +
// a dónde navega elegir un plan + cuál es el plan actual. El .tsx solo arma
// la grilla de cards con lo que este hook ya resolvió. `isAdmin` deja
// bloquear la página entera para un seller que entre por URL directa.
export const useMembershipPlansPage = (): UseMembershipPlansPageReturn => {
    ...
    return { status, statusLoading, statusError, plans, plansLoading, plansError, selectPlan, isPlanCurrent, isAdmin };
};
