...
// acá para que el .tsx solo elija qué bloque de texto mostrar. El plan es de
// la cuenta (no del kiosco activo), así que cualquier usuario autenticado
// puede ver el resultado de su propio checkout.
