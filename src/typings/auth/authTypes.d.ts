...
import type { AuthBrandVideoPhaseEnum, AuthPageModeEnum, ResetPasswordStatusEnum, VerifyEmailStatusEnum } from "./authEnums";
...
export interface UseAuthPageModeReturn {
